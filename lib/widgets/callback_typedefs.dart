...
///
/// These name widget-layer types, so they cannot live in `util/typedefs.dart`:
/// that file is imported by 37 libraries at the bottom of the stack and must
/// not depend on anything above it.
