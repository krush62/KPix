...
class KPalRampData
{
  ...
  })
  {
    ...
    updateColors(colorCountChanged: true, resetListeners: historyShifts == null);
  }
  ...
  void updateFromOther({required final KPalRampData other})
  {
    ...
    updateColors(colorCountChanged: colorChange);
  ...
  void _shiftChanged()
  {
    updateColors(colorCountChanged: false);
  }

  void updateColors({required final bool colorCountChanged, final bool resetListeners = true})
  {
